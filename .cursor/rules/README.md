...
- `/pm` 或 `/product-manager` - 产品经理角色（需求分析、PRD 编写）
- `/summarize` 或 `/summarizer` - 项目总结角色（文档整理、导航文件更新）⭐ 新增
- `/git` 或 `/commit` - Git 提交角色（代码提交、版本管理）⭐ 新增
...
- **Git 提交角色**: "提交"、"git"、"commit"、"代码提交" ⭐ 新增

## 📚 规则文件说明

### 架构和规范类

- **architecture.md** - 项目架构规范、目录结构、Next.js App Router 架构
- **coding-standards.md** - TypeScript 编码规范、错误处理、日志规范
- **api-design.md** - RESTful API 规范、影视资源 API 规范、多源聚合搜索
- **frontend.md** - Next.js 规范、组件规范、状态管理、播放器集成
- **testing.md** - 单元测试规范、测试场景、测试覆盖率
- **common.md** - 安全规范、性能优化、Docker 规范、MoonTV 特定规范
...
- **product-manager.md** - 产品经理模式、需求分析流程、PRD 输出标准
- **project-summarizer.md** - 项目总结和文档整理角色、文档管理流程、导航文件更新 ⭐ 新增
- **git-committer.md** - Git 提交角色定义、提交信息规范、版本管理流程 ⭐ 新增
...
1. **文件大小**: 每个规则文件应该保持合理大小（建议 < 500 行）
...
- **项目文档**: `README.md` - 项目介绍和部署指南
- **项目分析**: `PROJECT_ANALYSIS.md` - 项目深度分析和技术细节
- **架构流程**: `ARCHITECTURE_FLOW.md` - 系统架构和流程图
- **D1 初始化**: `D1初始化.md` - Cloudflare D1 数据库初始化脚本
