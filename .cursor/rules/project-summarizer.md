...
- ✅ **必须**：文档名称必须是中文
- ✅ **功能文档**：`YYMMDD-功能名称.md`（如 `251224-播放源测速优化.md`）
- ✅ **修复文档**：`YYMMDD-问题名称-修复.md`（如 `251219-搜索超时修复.md`）
- ✅ **分析文档**：`YYMMDD-分析主题-分析报告.md`（如 `251224-搜索性能分析报告.md`）
- ✅ **使用指南**：`YYMMDD-功能名称-使用指南.md`（如 `251212-播放功能使用说明.md`）
...
1. 检查 `docs/features/` 目录，发现已有 `251219-播放源测速优化.md`
2. 更新现有文档（如需要）
3. 更新 `CHANGELOG.md`：添加 2025-12-19 的更新记录
4. 更新 `PROJECT_STATUS.md`：在"最近修复"部分添加播放功能优化记录
5. 更新 `README.md`：在"重要更新"部分添加播放功能优化说明
...
1. 创建 `docs/fixes/251222-搜索超时修复.md`
2. 创建 `docs/features/251222-搜索性能优化.md`（优化文档）
...
**对话内容**：分析了搜索性能问题，生成了诊断报告

**整理步骤**：

1. 创建 `docs/analysis/251224-搜索性能分析报告.md`
...
- **CHANGELOG 格式**: 参考 `CHANGELOG.md` 中的最新记录
- **PROJECT_STATUS 格式**: 参考 `PROJECT_STATUS.md` 中的最新记录
